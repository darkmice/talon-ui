...
description: Where to look up colour, spacing, radius, shadow, and motion values.
---
...
`display 32/40 · h1 24/32 · h2 20/28 · h3 16/24 · body 14/22 · caption 12/18 · mono-sm 12/18` available as `text-display`, `text-h1`, …
