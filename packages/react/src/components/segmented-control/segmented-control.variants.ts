...
export const segmentedControlRootVariants = cva(
  ['inline-flex rounded-lg border border-border bg-bg-subtle dark:bg-bg-app p-1'],
  {
    variants: {
      size: {
        sm: 'gap-0.5',
...
export const segmentedControlItemVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      selected: {
        true: 'bg-bg-surface dark:bg-bg-surface-2 font-medium text-text-primary shadow-[0_1px_3px_rgba(15,23,42,0.12),0_1px_2px_rgba(15,23,42,0.08),0_0_0_1px_rgba(15,23,42,0.08)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)]',
