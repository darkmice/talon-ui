...
module.exports = {
  ...
  plugins: [
    ...
    function ({ addUtilities, addComponents }) {
      ...
      addUtilities({
        '.tp-status-progress': { backgroundColor: 'var(--tp-status-progress-bg)', color: 'var(--tp-status-progress-fg)' },
        '.tp-status-pending':  { backgroundColor: 'var(--tp-status-pending-bg)',  color: 'var(--tp-status-pending-fg)' },
        '.tp-status-done':     { backgroundColor: 'var(--tp-status-done-bg)',     color: 'var(--tp-status-done-fg)' },
        '.tp-status-blocked':  { backgroundColor: 'var(--tp-status-blocked-bg)',  color: 'var(--tp-status-blocked-fg)' },
        '.tp-status-idle':     { backgroundColor: 'var(--tp-status-idle-bg)',     color: 'var(--tp-status-idle-fg)' },
        '.tp-status-info':     { backgroundColor: 'var(--tp-status-info-bg)',     color: 'var(--tp-status-info-fg)' },
      });
    },
  ],
};
